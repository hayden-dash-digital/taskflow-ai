/* RoomHeader.jsx — timer, live badge, participants, team vibe bar, exit */
...
import RoomPulseBar from "../pulse/RoomPulseBar";
...
export default function RoomHeader({ h, t, onExit }) {
  ...
  return (
    <div style={{ background: t.side, borderBottom: `1px solid ${t.cb}`, flexShrink: 0 }}>
